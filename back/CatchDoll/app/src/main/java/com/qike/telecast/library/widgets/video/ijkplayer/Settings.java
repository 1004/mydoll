...
package com.qike.telecast.library.widgets.video.ijkplayer;
...
public class Settings {
    ...
    /**
     * 是否为硬解模式
     * @return true:是硬解  false:不是硬解
     */
    public static boolean isHardCodec(){
        return PreferencesUtils.loadPrefBoolean(CdApplication.getApplication(), "fy_codec_key", false);
    }

    /**
     * 设置编码模式  true:是硬解码 false:不是硬解
     * @param isHard
     */
    public static void setCode(boolean isHard){
        PreferencesUtils.savePrefBoolean(CdApplication.getApplication(),"fy_codec_key",isHard);
    }
